...
Highlighting, snippets, **diagnostics**, outline, CodeLens, **color chips**, hover, go to definition, find references, highlight, rename, code actions, **Run File**, and **Run Tests** for `.rg` files. Talks to `build\RoseGoldC.exe`.
